...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../fig/fig06_field_management_interfaces.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../fig/fig07_weather_phenology_interfaces.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../fig/fig08_disease_risk_timeline.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../fig/fig09_alert_notification_interfaces.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{../fig/fig10_task_management_interfaces.png}
...
The recognition module supports field-image-based assistance. Users can select an image from the camera or gallery, preview it in the mobile client, and upload it for recognition. Before upload, the image can be resized and compressed to reduce transmission load. The backend image-recognition service classifies grape images into disease or healthy categories and returns corresponding diagnostic or management text to the user. In the current operational workflow, the image-based module is used primarily to support field evidence collection and auxiliary recognition for grapevine downy mildew and powdery mildew, consistent with the main disease-risk simulation targets. Other disease or abnormality labels are retained as auxiliary categories rather than as primary validation targets in this study.
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{../fig/fig12_image_assistance_workflow.png}
